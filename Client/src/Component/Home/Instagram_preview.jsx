    ...
    <div className="relative bg-white">
      ...
      <div className="px-6 pt-6" style={{paddingLeft:16,paddingRight:16,paddingTop:4}}>
        ...
        <div className="flex gap-3 mt-5" style={{paddingBottom:4}}>
          <Link to={'https://instagram.com'} className="flex-1 flex justify-center items-center bg-gray-100 py-2 h-7 rounded text-sm  overflow-hidden" >
            Follow
          </Link>
          <Link to={'https://instagram.com'} className="flex-1 flex justify-center items-center bg-gray-100 py-2 h-7 rounded text-sm  overflow-hidden" >
            Message
      ...
      {/* TABS */}
      <div className="flex justify-around  py-3" style={{borderBottom:'2px solid black'}}>
        <Grid size={20} />
...
export default function App() {
  return (
    <div className="relative">
      ...
      >
        <h1 style={{ fontFamily: "Sub Heading",overflow:'hidden',textDecoration:'underline' }}>Instagram Preview</h1>
      </motion.div>
      <motion.div
        ...
        transition={{duration:1,ease:'easeInOut'}}
      >
        <h1 style={{ fontFamily: "Sub Heading",overflow:'hidden',textDecoration:'underline' }}>Follow US </h1>
      </motion.div>
      <div className=" flex  justify-center overflow-hidden " style={{backgroundColor:Color.EarlGray,padding:'2vh',backgroundImage:'url(Back2Hero.png)',backgroundBlendMode:'color-dodge',backgroundSize:'50%'}}>
        <Iphone>
          <InstagramProfile />
        </Iphone>
      </div>
